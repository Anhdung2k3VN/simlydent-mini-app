  ...
  return (
    <div className="relative flex h-screen w-full flex-col justify-between overflow-hidden bg-background-light dark:bg-background-dark p-6">
      ...
      <div className="flex flex-col items-center justify-center w-full z-10">
        <div className="mb-8 relative group">
          ...
          <div className="relative w-32 h-32 bg-white dark:bg-[#1a2c35] rounded-3xl shadow-xl shadow-primary/10 flex items-center justify-center border border-slate-100 dark:border-slate-800">
            <span className="material-symbols-outlined text-6xl text-primary">dentistry</span>
          </div>
        </div>
        
        <div className="flex flex-col items-center text-center space-y-2">
          <h1 className="text-slate-900 dark:text-white tracking-tight text-4xl font-extrabold leading-tight">SimlyDent</h1>
          <h2 className="text-slate-500 dark:text-slate-400 text-lg font-medium tracking-wide">Nha Khoa Thẩm Mỹ</h2>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-end pb-12 w-full max-w-xs mx-auto z-10">
        ...
        <div className="mt-8">
          <p className="text-slate-400 dark:text-slate-600 text-xs font-medium text-center">v1.0.0</p>
        </div>
      </div>
    </div>
  );
